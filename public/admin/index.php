    ...
    <main>
        <div class="container" style="background-color: white; width: 70%;">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-grid gap-2 col-5 mx-auto">
                        <button class="btn btn-outline-primary" onclick="send_to_estudiante()">Ver Estudiantes</button>
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-12">
                    <div class="d-grid gap-2 col-5 mx-auto ">
                        <button class="btn btn-outline-info" onclick="send_to_casillero()">Ver Casilleros</button>
                    </div>
                </div>
            </div>
            <br>
