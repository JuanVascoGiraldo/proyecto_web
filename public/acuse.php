...
<body>
    ...
    <main>
        <section>
            <form lass="form-signin" id="form_student" name="form_student" method="POST">
                <img class="mb-4" src="./imgs/acuse.png">
                ...
                <br>
                <button class="btn btn-outline-light w-100 py-2" type="button" onclick="validar_formulario()">Ingresar</button>
            </form>
            <div id="loader"></div>      
        </section>
    </main>
